...
const BlogDetail = async ({params}: {params: {id: string}}) => {
    ...
    return (
      <PageContainer classes="flex justify-center w-full min-h-screen mt-10">  
        <div className="flex flex-col w-[1200px]">
          <div className="flex-center">
            <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] xl:h-[600px] xl:rounded-lg">
              <Image 
              ...
              <div className="mt-16 max-w-[700px]">
                {data.blogDescriptions.map(desc => (
                  <div className="mb-10" key={desc._id}>
                    ...
                    <p className="dark:text-gray-300 text-gray-700 font-medium leading-[1.9] tracking-[0.5px]">{desc.descriptionContent}</p>
                  </div>
                ))}
              </div>
            </div>
